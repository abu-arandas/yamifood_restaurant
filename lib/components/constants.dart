...
class App {
  ...
  static void Function() facebook = () async =>
      await launchUrl(Uri.parse('https://web.facebook.com/abu00arandas/'));
  static void Function() instagram = () async =>
      await launchUrl(Uri.parse('https://www.instagram.com/abu_arandas/'));
}
...
BoxShadow primaryShadow =
    BoxShadow(color: primary, blurRadius: 2, blurStyle: BlurStyle.outer);
BoxShadow whiteShadow =
    BoxShadow(color: white, blurRadius: 10, blurStyle: BlurStyle.outer);
BoxShadow blackShadow =
    BoxShadow(color: secondary, blurRadius: 10, blurStyle: BlurStyle.outer);
...
InputDecoration inputDecoration(String text, Color color, Widget? suffixIcon) =>
    InputDecoration(
      label: Text(text),
      hintText: text,
      labelStyle:
...
Center waitContainer() => const Center(child: CircularProgressIndicator());
...
TextStyle title({required BuildContext context, Color? color}) =>
