...
class OrderServices extends GetxController {
  ...
  Stream<List<OrderModel>> driverOrders() {
    return ordersCollection
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                                image: MemoryImage(base64Decode(drivers[index].image)),
                                fit: BoxFit.fill),
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            BootstrapHeading.h4(
                                text:
                                    '${drivers[index].name['firstName']} ${drivers[index].name['lastName']}'),

                            // Distance
                            BootstrapHeading.h4(
                              text: AddressServices.instance
                                  .calculateDistance(
